      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {whyChooseUsPoints.map((point, i) => (
            <motion.div key={point.title} initial={{ opacity: 0, scale: 0.9 }} animate={inView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.4, delay: i * 0.08 }} className="glass-dark rounded-2xl p-6 text-center hover:bg-secondary/10 transition-all duration-500 group">
